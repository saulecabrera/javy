...
# Even though `jacrt` is a WASI target, we test it as a native plugin
# to avoid errors related to missing imports, since the dynamic
# linking nature of the Wasm artifacts is harder to orchestrate for
# unit tests.
# The end-to-end flow for the compiler will be tested as part of the CLI
# integration tests.
