...
pub fn print(bytecode: &[u8]) -> Result<String> {
...
impl Printer {
    ...
    fn print_op(
        ...
        match op {
            ...
            InitCtor => write!(self.writer, "InitCtor"),
            ...
            PushBigintI32 { value } => write!(self.writer, "PushBigintI32 {}", value),
            ...
            GetLoc0Loc1 => write!(self.writer, "GetLoc0Loc1"),
